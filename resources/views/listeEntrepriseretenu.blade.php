...
<div class="row text-center">
    <div class="col-sm-6 col-lg-3">
        <a href="{{ route("dashboardliste") }}" class="widget widget-hover-effect2">
    ...
    <div class="col-sm-6 col-lg-3">
        <a href="javascript:void(0)" class="widget widget-hover-effect2">
            <div class="widget-extra themed-background">
                <h4 class="widget-content-light"><strong></strong>Souscriptions</strong> Enregistées Subvention</h4>
            </div>
    ...
    <div class="table-responsive">
        ...
        <tbody>
            @php
              $i=0;
            @endphp
            @foreach ($entreprises_retenus as $entreprise)
                    @php
                       $i++;
                    @endphp
                <tr>
