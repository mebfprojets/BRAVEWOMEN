        ...
        <!-- Basic Form Elements Title -->
                ...
                <div class="block">
                    ...
                    <div class="block-title">
                        <h2> Créer une <strong>banque parténaire</strong></h2>
                    </div>
                    <form id="form-validation" method="POST"  action="{{route('banque.store')}}" class="form-horizontal form-bordered">
                            {{ csrf_field() }}
                            <div class="form-group{{ $errors->has('libelle') ? ' has-error' : '' }}">
                                <label class="col-md-4 control-label" for="nom">Nom de la banque<span class="text-danger">*</span></label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('libelle') ? ' has-error' : '' }}">
                                <label class="col-md-4 control-label" for="telephone">Contacts<span class="text-danger">*</span></label>
                                <div class="col-md-6">
                                    <div class="input-group">
