        ...
        <!-- Basic Form Elements Title -->
                ...
                <div class="block">
                    ...
                    <div class="block-title">
                        <h2> Liste <strong>des demandes de paiements payés</strong></h2>        
                    </div>
        ...
        <tbody>
            @foreach($factures as $facture)
             ...
             @if(return_facture($facture->facture_id)->historique_payee)
                @if( return_diffdate(return_facture($facture->facture_id)->historique_payee->date_statut, return_facture($facture->facture_id)->historique_validee->date_statut )  > 10) 
                style = "color:red"
                @else
                 style = "color:green"
                @endif
