        ...
        <!-- Basic Form Elements Title -->
                ...
                <div class="block">
                    ...
                    <div class="block-title">
                        <h2> Liste des acomptes de <strong>{{ $entreprise->denomination }}</strong></h2>
                            <a href="#modal-add-account" data-toggle="modal" class="btn btn-success pull-right"><span><i class="fa fa-plus"></i></span>Accompte</a>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header text-center">
                <h2 class="modal-title"><i class="fa fa-pencil"></i> Ajouter un Accompte</h2>
            </div>
            <!-- END Modal Header -->
                    ...
                    <input type="hidden" name="id_table" id="id_table">
                        <form id="form-validation" method="POST"  action="{{route('accompte.store')}}" class="form-horizontal form-bordered"  enctype="multipart/form-data">
                            ...
                            <div class="form-group{{ $errors->has('libelle') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                            {{-- <input id="mtnt" type="hidden" min=0 class="form-control montant" name="montant"   required autofocus> --}}
                                             <input  name="montant" class="form-control CurrencyInput"   placeholder="1 000 000" required autofocus> 
                            ...
                            <div class="form-group{{ $errors->has('libelle') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                            <input id="name" type="date" class="form-control" name="date" value="{{ old('date') }}" required autofocus>
