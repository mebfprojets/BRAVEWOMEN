        ...
        <!-- Basic Form Elements Title -->
                ...
                <div class="block">
                    ...
                    <div class="block-title">
                        <h2> Liste <strong>des Devis à suivre</strong></h2>        
                    </div>
                    ...
                    <td class="text-center">
                            <div class="btn-group">
                              @can('update_suivi_execution_devis', Auth::user()) 
                                <a href="{{ route('devi.show',$devi) }}" data-toggle="tooltip" title="Visualiser le devis" class="btn btn-md btn-success"><i class="fa fa-eye"></i></a>
                                <a href="{{ route('devis.suivre',$devi) }}" data-toggle="tooltip" title="Suivre l'exécution" class="btn btn-md btn-warning"><i class="fa fa-line-chart"></i></a>
                             @endcan 
                            </div>
                    </td>
                </tr>
