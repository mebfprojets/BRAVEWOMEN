        ...
        <!-- Basic Form Elements Title -->
                ...
                <div class="block">
                    ...
                    <div class="block-title">
                        <h2> Enregistrement <strong>d'une subvention au profit de {{ $entreprise->promotrice->code_promoteur }}</strong></h2>
                    </div>
                            ...
                            <div class="form-group{{ $errors->has('libelle') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                           <input id="montant_subvention" type="number" min=0 class="form-control" name="montant" value="{{ old('montant') }}" onchange="valider_montant_accompte();" required autofocus>
