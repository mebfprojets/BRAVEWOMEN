    ...
    <!-- Basic Form Elements Title -->
            ...
            <div class="block">
                ...
                <div class="block-title">
                    <h2> Modification de la facture <strong></strong></h2>        
                </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-5" style="margin-left: 15px;">
                <label class="control-label " for="example-chosen">Mode de paiement<span class="text-danger">*</span></label>
                    <select id="mode_de_paiement_u" name="mode_de_paiement" class="select-select2 mode_de_paiement_1"  onchange="changer_mode_de_paiement('mode_de_paiement_1','champ_paiement_cheque_ou_virement_u','champ_paiement_mobile_u','champ_paiement_cheque_u');"  style="width: 100%;" required>
                        <option></option>
            ...
            <div class="champ_paiement_cheque_ou_virement_u" >
