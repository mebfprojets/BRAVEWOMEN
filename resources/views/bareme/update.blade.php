        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="block">
                    ...
                    <form id="form-validation" method="POST"  action="{{route('baremes.update',$bareme)}}" class="form-horizontal form-bordered">
                                    ...
                                    <option></option>
                                        @foreach ( $criteres as $critere)
                                            <option value="{{ $critere->id }}"
                                                @if ($critere->id == $bareme->valeur_id)
                                                selected
                                           @endif>{{ $critere->libelle }}</option>
                                        @endforeach
                                </select>
                            </div>
                            </div>
                            <div class="form-group{{ $errors->has('nom') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                                <input id="name" type="number" class="form-control" name="val_inf" value="{{ old('val_inf')?? $bareme->valeur_inf }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                    <label class="col-md-4 control-label" for="val_sup">Valeur Inferieure<span class="text-danger">*</span></label>
                                    <div class="col-md-6">
                                        <div class="input-group">
                                                <input id="name" type="number" class="form-control" name="val_sup" value="{{ old('val_sup')?? $bareme->valeur_sup }}" required autofocus>
                                            <span class="input-group-addon"><i class="gi gi-user"></i></span>
                                        </div>
                                ...
                                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                                <input id="name" type="number" class="form-control" name="note" value="{{ old('note')?? $bareme->note }}" required autofocus>
                                            <span class="input-group-addon"><i class="gi gi-user"></i></span>
                                        </div>
                                        @if ($errors->has('note'))
                                        <span class="help-block">
