...
@endif
    ...
    @if($promoteur->suscriptionaopleader_etape == 1)
        ...
        <a href="{{ route('entrepriseaopl.new', $promoteur->code_promoteur ) }}?typeentreprise=aop" data-toggle="modal" class="btn btn-success" >Poursuivre avec une AOP</a>
        <a href="{{ route('entrepriseaopl.new', $promoteur->code_promoteur ) }}?typeentreprise=leader" data-toggle="modal" class="btn btn-success" >Poursuivre avec une entreprise leader</a>
