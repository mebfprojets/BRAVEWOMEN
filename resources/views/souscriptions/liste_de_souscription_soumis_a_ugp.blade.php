        ...
        <table id="" class="table table-vcenter table-condensed table-bordered listepdf">
            <thead>
                <tr>
                    ...
                    <th class="text-center">Phase de soucription</th>
                    <th class="text-center">Type d'entreprise</th>

                    <th class="text-center" style="width:10px;" >Region</th>
                    <th class="text-center" style="width:10px;" >Province</th>
                    <th class="text-center" style="width:10px;" >Commune</th>
                    <th class="text-center" style="width:10px;" >Secteur</th>
