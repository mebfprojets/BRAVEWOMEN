                                ...
                                <div class="col-md-6">
                                    <select id="type_formation" name="type_formation" class="select-select2" data-placeholder="Choisir le type de systeme de suivi" style="width: 100%;"  >
                                        ...
                                        @foreach ($type_formations as $type_formation )
                                            <option value="{{$type_formation->id  }}" {{ old('type_formation') == $type_formation->id ? 'selected' : '' }} value="{{ $type_formation->id }}">{{ $type_formation->libelle }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4" for="date_debut">Date debut<span class="text-danger">*</span></label>
                                    <div class="input-group col-md-6">
                                        <input type="text" id="date_debut" name="date_debut" value="{{old('date_debut')}}" class="form-control input-datepicker" data-date-format="yyyy-mm-dd" placeholder="Entrer la date de debut.." required="Ce champ est obligatoire">
                                        <span class="input-group-addon"><i class="gi gi-user"></i></span>
                                    </div>
                            </div>
                            <div class="form-group">
