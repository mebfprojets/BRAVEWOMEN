            ...
            @foreach($formations as $formation)
                <tr>
                    ...
                    <td class="text-center">
                            ...
                            <a href="{{ route('listedepresence.telecharger',$formation) }}"  data-toggle="tooltip" title="Télécharger la liste de présence" class="btn btn-xs btn-success"><i class="hi hi-paperclip"></i></a>
