        ...
        <div class="progress progress-striped active">
            <div id="progress-bar-wizard" class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: 0"></div>
                            ...
                            <fieldset>
                                <legend>Informations sur l'activite</legend>
                                    <div class="col-md-5">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label" for="example-chosen">Entreprise est-elle formalisées?<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group" >
                                                <label class="control-label " for="">Nombre d'homme<span class="text-danger">*</span></label>
                                                    <div class="input-group">
                                                        <input id="nbre_homme" type="number" min="0" max="100" name="nbre_homme" class="form-control" data-placeholder="Nombre de femme dans l'activité" value="{{old("nbre_homme")}}" required >
                                                    </div>
                                            </div>
                                        </div>
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label class="control-label " for="">Nombre de femme<span class="text-danger">*</span></label>
                                                <div class="input-group">
                                                    <input id="nbre_femme" type="number" min="0" max="100" name="nbre_femme" class="form-control" data-placeholder="Nombre de femme" value="{{old("nbre_femme")}}" required >
                                                </div>
                                        </div>
                                    </div>
                                </div>
                     ...
                     <div id="progress-second" class="step">
                            <div class="row">
                                <fieldset>
                                    ...
                                    <label class=" control-label" for="">Quelles sont les activités verticales développées? </label>
                                    <div class="form-group">
                                        @php
                                        $j=1;
                                    @endphp 
                                        @foreach ($activites_verticales as $activites_verticale)
                                            ...
                                            <div class="col-lg-2 checkbox">
                                               <label><input type="checkbox" name='activites_verticales[]' value="{{ $activites_verticale->id }}"> AV{{ $j }}<span data-toggle="tooltip" title="{{ $activites_verticale->libelle }}"><i class="fa fa-info-circle"></i></span></label>
                                            </div>
                                            @php
                                            $j++;
                                        @endphp
                                    ...
                                    @endphp
                                        @foreach ($activites_horizotales as $activites_horizotale)
                                            ...
                                            <div class="col-lg-2 checkbox">
                                               <label><input type="checkbox" name='activites_horizotales[]' value="{{ $activites_horizotale->id }}"> AH{{ $i }}<span data-toggle="tooltip" title="{{ $activites_horizotale->libelle }}"><i class="fa fa-info-circle"></i></span></label>
                                            </div>
                                            @php
                                            $i++;
                                        @endphp
                                    ...
                                    {{-- </div> --}}
                                        ...
                                        <label class=" control-label" for="">Pensez-vous investir dans des activités verticales <span data-toggle="tooltip" title="Pensez-vous investir dans des activités verticales en 2022 ou /et en 2023 ? "><i class="fa fa-info-circle"></i></span></label>
                                    <div class="form-group">
                                        @php
                                        $j=1;
                                    @endphp 
                                        @foreach ($activites_verticales as $activites_verticale)
                                            ...
                                            <div class="col-lg-2 checkbox">
                                               <label><input type="checkbox" name='activites_verticales_invests[]' value="{{ $activites_verticale->id }}"> AV{{ $j }}<span data-toggle="tooltip" title="{{ $activites_verticale->libelle }}"><i class="fa fa-info-circle"></i></span></label>
                                            </div>
                                            @php
                                            $j++;
                                        @endphp
                                    ...
                                    <label class=" control-label" for="">Pensez-vous investir dans des activités horizontales <span data-toggle="tooltip" title="Pensez-vous investir dans des activités horizontales en 2022 ou /et en 2023 ? "><i class="fa fa-info-circle"></i></span></label>
                                    <div class="form-group">
                                        @php
                                        $i=1;
                                    @endphp
                                        @foreach ($activites_horizotales as $activites_horizotale)
                                            <div class="col-lg-2 checkbox">
                                               <label><input type="checkbox" name='activites_horizotales_invests[]' value="{{ $activites_horizotale->id }}"> AH{{ $i }}<span data-toggle="tooltip" title="{{ $activites_horizotale->libelle }}"><i class="fa fa-info-circle"></i></span></label>
                                            </div>
                                            @php
                                            $i++;
                                        @endphp
                ...
                <div class="row">
                    ...
                    <div class="offset-md-1 col-md-5">
                        <div class="form-group">
                            <label class="control-label" for="example-chosen">Pouvez-vous mobiliser la contrepartie? <span class="text-danger">*</span><span data-toggle="tooltip" title="Pouvez-vous mobiliser une somme de 30 000 000 F.CFA comme subvention de contrepartie pour financer vos relations de partenariat décrites plus haut?"><i class="fa fa-info-circle"></i></span></label>
                                <select id="mobililise_contrepartie" name="mobililise_contrepartie" class="select-select2" onchange="afficher();" data-placeholder="Pouvez-vous mobiliser une somme de 30 000 000 comme contrepartie pour financer votre entreprise " style="width: 100%;" required>
                                    <option></option>
