...
@section('content')
            ...
            <div class=" col-xs-10 block-content ">
                            ...
                            <div class="tab-pane active" id="example-tabs2-activity" style="height:600px;background: #fff">
                                <div class="row">
                                    <div class="col-md-6">
                        ...
                        {{-- <div  id="" class="form-group">
                            <p class="col-md-4 control-label labdetail"><span class="">Lieu d'établissement : </span> </p>
                                <p class="col-md-6" >
                                <span class="labdetail">
                                @empty($entreprise->promotrice->lieu_etablissement)
                                                    Informations non disponible
                                                    @endempty
                                     {{$entreprise->promotrice->lieu_etablissement}}
                            </span></p>
                        </div> --}}
                        {{-- <div  id="" class="form-group " >
                            <p class="col-md-4 control-label labdetail"> <span class="">Autorite de delivrance : </span></p>
                            <p class="col-md-6" >
                            <span class="valdetail">
                                @empty($entreprise->promotrice->date_etabli_identite)
                                                    Informations non disponible
                                                    @endempty
                                    @if($entreprise->promotrice->autorite_delivrance==1)
                                                ONI
                                    @else
                                            Autre
                                     @endif
                        ...
                        {{-- <div  id="" class="form-group">
                            <p class="col-md-4 control-label labdetail"> <span class="">Compte bancaire disponible? : </span> </p>
                            <p class="col-md-6">
                            <span class="valdetail">
                                @empty($entreprise->promotrice->compte_perso_existe)
                                            Informations non disponible
                                            @endempty
                                @if($entreprise->promotrice->compte_perso_existe==1)
                        ...
                        <div  id="" class="row form-group row">
                            ...
                            <span class="valdetail">
                               ...
                               <div class="tab-pane" id="example-tabs2-profile" style="height:600px;background: #fff">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div  id="condanation" class="form-group row">
                                    ...
                                    <div class="tab-pane" id="indicateurs-entreprise" style="height:700px;">
                                        <div class="row mt-6" >
                                    <div class="col-md-3 ">
            ...
            <tr>
             ...
             @endforeach
                                    ...
                                    <div class="tab-pane" id="example-tabs2-options" style="height:500px;">
                                        <div class="row">
                                            <div class="col-md-10">
                                                <div  id="condanation" class="form-group">
                                    ...
                                    <div class="control-label">
                                        ...
                                        <table class="table table-vcenter table-condensed table-bordered listepdf valdetail"   >
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('detaildocument',$piecejointe->id)}}"title="télécharger" class="btn btn-xs btn-default" ><i class="fa fa-eye"></i> </a>
                                            </td>
                                ...
                                <div class="tab-pane" id="example-tabs2-decisions" style="height:500px;">
                                    ...
                                    @foreach ( $entreprise->evaluations as $evaluation )
                                        <div class="row">
                                            <div  id="condanation" class="form-group">
                                                <p class="col-md-5 control-label labdetail"><span class="">{{ $evaluation->indicateur }} : </span> </p>
                                                    <p class="col-md-7" >
                                                    <span class="valdetail">
                                    ...
                                    @endforeach
                                        <div  id="condanation" class="form-group">
                                            <p class="col-md-5 control-label labdetail"><span class="">Total : </span> </p>
                                                <p class="col-md-7" >
                                                <span class="valdetail">
                            ...
                            <div class="col-md-6">
                                <div  id="condanation" class="form-group">
                                    <p class="col-md-6 control-label labdetail"><span class="">Decison de l'UGP : </span> </p>
                                        <p class="col-md-6" >
                                        <span class="valdetail">
                                ...
                                @php
                                    $i=0;
                                @endphp
                                @foreach ($entreprise->decisions as $decisions )
                                @php
                                    $i++;
                                @endphp
                                <div class="row">
                                    <div  id="condanation" class="form-group">
                                        <p class="col-md-6 control-label labdetail"><span class="">Decison du membre {{ $i }}  : </span> </p>
                                            <p class="col-md-6" >
                                            <span class="valdetail">
                                            @empty($decisions->decision)
                                              ...
                                              @endempty
                                                 {{$decisions->decision}}
                                                @if($decisions->decision=="Ajournée")
                                                    pour {{ $decisions->raison }}
                                                @endif
                                        </span></p>
                                    </div>
                                </div>
